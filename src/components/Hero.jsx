    ...
    >
        <div className="container relative" ref={parallaxRef}>
            ...
            text-center mb-[4rem] md:mb-20 lg:mb:[6rem]">
                <h1 className="h1 mb-6">Explorez les possibilités &nbsp; de l'IA
                &nbsp; </h1>
                <img src={curve} 
            ...
            md:max-w-5xl xl:mb-24">
                ...
                bg-conic-gradient">
                    <div className="relative bg-n-8 rounded-[1rem]">                            <div className="h-[1.4rem] bg-n-10
                        rounded-t-[0.9rem]"/>
